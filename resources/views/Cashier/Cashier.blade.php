                    ...
                    <div class="row">
                        <div class="row mt-5">
                            ...
                            <div class="row" style="max-height: 650px; overflow-y: auto;">
                                <!-- Tinggi maks sudah ditingkatkan -->
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ps-3" style="flex-grow: 1;">
                                                        ...
                                                        <p class="text-muted small product-code">{{ $item->product_code }}
                                                        </p> <!-- CSS responsif -->

                                                        <form method="post" class="OrderProduct"
                                                            data-id="{{ $item->id }}">
                                                            @csrf
                            ...
                            <form method="POST" id="CheckOutTable" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="text-right">
                                        ...
                                        {{-- <button type="submit" class="btn btn-danger mt-3" name="checkout_type"
                                            value="debt">Debt</button> --}}
                                    </div>
